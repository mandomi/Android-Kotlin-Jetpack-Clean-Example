...
class GetMoviesUsecase @Inject constructor(
        ...
        postExecutionThread: PostExecutionThread) : SingleUseCase<List<Movie>, None>(useCaseExecutor, postExecutionThread) {

    override fun buildSingle(params: None): Single<List<Movie>> {
